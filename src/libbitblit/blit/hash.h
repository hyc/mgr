 ...
 */
/*	$Header: hash.h,v 4.1 88/06/21 13:19:08 bianchi Exp $
	$Source: /tmp/mgrsrc/src/blit/RCS/hash.h,v $
*/
static char	h_hash_[] = "$Source: /tmp/mgrsrc/src/blit/RCS/hash.h,v $$Revision: 4.1 $";
